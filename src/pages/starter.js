...
import LogoLg from "../assets/images/logo-dark.png";
import LogoSm from "../assets/images/logo-light.svg";
import LogoLgSm from "../assets/images/logo-light.png";
...
import AvatarTwo from "../assets/images/users/avatar-3.jpg";
import AvatarThree from "../assets/images/users/avatar-4.jpg";
            ...
            <div className="d-flex">
              ...
              <div className="navbar-brand-box">
                ...
                <a href="index.html" className="logo logo-light">
                  ...
                  <span className="logo-lg">
                    <img src={LogoLgSm} alt="" height="19" />
                  </span>
                </a>
              </div>
            ...
            <div className="d-flex">
              ...
              <div className="dropdown d-none d-lg-inline-block ms-1">
                ...
                >
                  ...
                  <Icon icon="bx:customize" className="bx bx-customize" />
                </button>
              ...
              <div className="dropdown d-none d-lg-inline-block ms-1">
                ...
                >
                  ...
                  <Icon icon="bx:fullscreen" className="bx bx-fullscreen" />
                </button>
              </div>
              ...
              <div className="dropdown d-inline-block">
                ...
                >
                  ...
                  <Icon icon="bx:cog" className="bx bx-cog" />
                </button>
              </div>
            </div>
          </div>
              ...
              <ul className="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                  ...
                  <ul className="sub-menu" aria-expanded="true">
                    <li>
                      <a href="#" className="has-arrow" key="t-vertical">
                        Vertical
                      </a>
                      <ul className="sub-menu" aria-expanded="true">
                        <li>
                ...
                <li>
                  ...
                  <ul className="sub-menu" aria-expanded="true">
                    ...
                    <li>
                      <a href="#" className="has-arrow" key="t-level-1-2">
                        Level 1.2
                      </a>
                      <ul className="sub-menu" aria-expanded="true">
                        <li>
